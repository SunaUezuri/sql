...
SELECT CONSTRAINT_NAME, CONSTRAINT_TYPE, SEARCH_CONDITION 
    FROM user_constraints WHERE TABLE_NAME = 'T_CKP_CATEGORIA';
...
ALTER TABLE T_CKP_AUTOR MODIFY DS_EMAIL VARCHAR(60) NULL;
DESC T_CKP_AUTOR;
...
SELECT CONSTRAINT_NAME, CONSTRAINT_TYPE, SEARCH_CONDITION 
    FROM user_constraints WHERE TABLE_NAME = 'T_CKP_LIVRO';


ALTER TABLE T_CKP_AUTOR_LIVRO DROP CONSTRAINT FK_CKP_AUTOR_LIVRO_AUTOR;
SELECT CONSTRAINT_NAME, CONSTRAINT_TYPE, SEARCH_CONDITION 
    FROM user_constraints WHERE TABLE_NAME = 'T_CKP_AUTOR_LIVRO';
