...
(
    ...
    DS_SIGLA_CATEGORIA  CHAR(3) NOT NULL    CONSTRAINT  UN_CKP_CATEGORIA_SIGLA  UNIQUE,
    DS_CATEGORIA    VARCHAR2(30)    NOT NULL   CONSTRAINT  UN_CKP_CATEGORIA_DESC   UNIQUE
);
ALTER TABLE T_CKP_CATEGORIA ADD CONSTRAINT PK_CKP_CATEGORIA  PRIMARY KEY (CD_CATEGORIA);

CREATE TABLE T_CKP_LIVRO(
    NR_OSBN NUMBER(8)   NOT NULL    CONSTRAINT PK_T_CKP_LIVRO   PRIMARY KEY,
    CD_CATEGORIA NUMBER(3) NOT NULL,
...
ALTER TABLE T_CKP_AUTOR_LIVRO ADD CONSTRAINT FK_CKP_AUTOR_LICRO_AUTOR FOREIGN KEY (CD_AUTOR)
